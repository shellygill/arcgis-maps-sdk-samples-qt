...
int main(int argc, char *argv[])
{
  ...
  qmlRegisterType<MapQuickView>("Esri.GraphicsMemoryManagementDemo", 1, 0, "MapView");

  // Register the GraphicsMemoryManagementDemo (QQuickItem) for QML
  qmlRegisterType<GraphicsMemoryManagementDemo>("Esri.GraphicsMemoryManagementDemo", 1, 0, "GraphicsMemoryManagementDemo");

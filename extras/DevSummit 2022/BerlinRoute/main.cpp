...
int main(int argc, char *argv[])
{
  ...
  ArcGISRuntimeEnvironment::setLicense("runtimeadvanced,1000,rud549870138,20-oct-2022,JFAZ0H4AH5C2PBT59033");
...
//  }
  ...
  qmlRegisterType<MapQuickView>("Esri.BerlinRoute", 1, 0, "MapView");

  // Register the BerlinRoute (QQuickItem) for QML
  qmlRegisterType<BerlinRoute>("Esri.BerlinRoute", 1, 0, "BerlinRoute");

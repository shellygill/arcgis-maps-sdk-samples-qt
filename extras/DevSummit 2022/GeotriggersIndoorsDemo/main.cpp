...
int main(int argc, char *argv[])
{
  ...
  qmlRegisterType<MapQuickView>("Esri.GeotriggersIndoorsDemo", 1, 0, "MapView");

  // Register the GeotriggersIndoorsDemo (QQuickItem) for QML
  qmlRegisterType<GeotriggersIndoorsDemo>("Esri.GeotriggersIndoorsDemo", 1, 0, "GeotriggersIndoorsDemo");
